...
namespace Pokedex.Services.UnitTests.TranslationService.ShakespeareTranslationService
{
    public class ShakespeareTranslationServiceTests
    {
        private readonly IShakespeareTranslationService _service;
        ...
        public ShakespeareTranslationServiceTests()
        {
            ...
            _service = new Services.TranslationService.ShakespeareTranslationService.ShakespeareTranslationService(flurlClientFactory, _mockOptions.Object);
        }
